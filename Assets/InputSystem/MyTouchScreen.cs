...
//     version 1.14.2
//     from Assets/MyTouchScreen.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/MyTouchScreen.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @MyTouchScreen: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ~@MyTouchScreen()
    {
        UnityEngine.Debug.Assert(!m_TouchScreen.enabled, "This will cause a leak and performance issues, MyTouchScreen.TouchScreen.Disable() has not been called.");
    }
    ...
    {
        private @MyTouchScreen m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public TouchScreenActions(@MyTouchScreen wrapper) { m_Wrapper = wrapper; }
        /// <summary>
